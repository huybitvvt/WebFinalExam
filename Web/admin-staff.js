const mockStaffSeedVersion = 'dngear-staff-seed-v2';
...
function buildMockStaff() {
    return [
        ...
        { id: 'NV05', name: 'Đào Ngọc Mai', gender: 'Nữ', phone: '0909111222', email: 'mai@gunstore.com', role: 'CSKH', salary: '11.800.000 đ' },
        { id: 'NV06', name: 'Bùi Gia Khánh', gender: 'Nam', phone: '0977111444', email: 'khanh@gunstore.com', role: 'Kỹ thuật viên', salary: '14.200.000 đ' },
        { id: 'NV07', name: 'Hoàng Minh Tâm', gender: 'Nam', phone: '0966444555', email: 'tam@gunstore.com', role: 'Điều phối đơn hàng', salary: '12.200.000 đ' },
        { id: 'NV08', name: 'Vũ Thu Trang', gender: 'Nữ', phone: '0945222333', email: 'trang@gunstore.com', role: 'Marketing store', salary: '13.400.000 đ' }
    ];
}
                    ...
                    <div class="admin-form-grid">
                        ...
                        <div class="admin-form-group">
                            ...
                            <select id="formStaffRole">
                                ...
                                <option value="Điều phối đơn hàng">Điều phối đơn hàng</option>
                                <option value="Marketing store">Marketing store</option>
                            </select>
                        </div>
                        <div class="admin-form-group">
