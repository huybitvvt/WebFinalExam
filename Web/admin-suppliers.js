...
function buildMockSuppliers() {
    return [
        ...
        { id: 'NCC05', name: 'Sentinel Guard Gear', contact: 'Võ Anh Thư', phone: '0908111000', email: 'thu@sentinelgear.vn', status: 'Hoạt động' },
        { id: 'NCC06', name: 'Iron Barrel Studio', contact: 'Ngô Tiến Long', phone: '0945333777', email: 'long@ironbarrel.vn', status: 'Hoạt động' },
        { id: 'NCC07', name: 'Nova Optics Lab', contact: 'Đinh Quốc Bảo', phone: '0966222555', email: 'bao@novaoptics.vn', status: 'Hoạt động' }
    ];
}
