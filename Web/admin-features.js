const mockPromotionSeedVersion = 'dngear-promotion-seed-v3';
    ...
    topGuns.forEach(p => {
        if (typeof window.createStoreProductCard === 'function') {
            container.innerHTML += window.createStoreProductCard(p, {
                ...
                metaText: p.tagline || 'Mẫu đang được ghim lên khu bán chạy để gian hàng trông sinh động hơn.',
...
function buildMockPromotions() {
    return [
        ...
        },
        {
            id: 'KM12',
            code: 'SHOTSHELL',
            title: 'Combo shotgun + vỏ đạn',
            valueLabel: 'Tặng 1 bộ vỏ đạn',
            condition: 'Áp dụng khi mua Remington M870 hoặc bất kỳ mẫu shotgun trong cửa hàng',
            uses: 74,
            usageLimit: 100,
            status: 'Đang áp dụng',
            rankValue: 1,
        ...
        },
        {
            id: 'KM13',
            code: 'TACTIC15',
            title: 'Giảm nhanh phụ kiện chiến thuật',
            valueLabel: 'Giảm 15%',
            condition: 'Áp dụng cho phụ kiện rail, ống ngắm và đèn pin',
            uses: 189,
            usageLimit: 200,
            status: 'Đang áp dụng',
            rankValue: 15,
        ...
        },
        {
            id: 'KM14',
            code: 'FOAMPACK',
            title: 'Súng xốp mua kèm đạn',
            valueLabel: 'Giảm 25$',
            condition: 'Mua súng bắn đạn xốp kèm tối thiểu 2 hộp đạn',
            uses: 92,
            usageLimit: 0,
            status: 'Đang áp dụng',
            rankValue: 25,
        ...
        },
        {
            id: 'KM16',
            code: 'VIPGEAR',
            title: 'Khách VIP mua kèm phụ kiện',
            valueLabel: 'Giảm 12%',
            condition: 'Áp dụng cho đơn có phụ kiện từ 180$',
            uses: 58,
            usageLimit: 180,
            status: 'Đang áp dụng',
            rankValue: 12,
        ...
        },
        {
            id: 'KM17',
            code: 'NIGHTOPS',
            title: 'Deal tác chiến đêm',
            valueLabel: 'Giảm 35$',
            condition: 'Mua đèn pin rail hoặc ống ngắm cho đơn từ 450$',
            uses: 41,
            usageLimit: 120,
            status: 'Đang áp dụng',
            rankValue: 35,
        ...
        },
        {
            id: 'KM18',
            code: 'ARMORSET',
            title: 'Combo đồ bảo hộ sân đấu',
            valueLabel: 'Tặng 1 combo',
            condition: 'Mua áo giáp hoặc kính bảo hộ trong cùng đơn hàng',
            uses: 27,
            usageLimit: 60,
            status: 'Đang áp dụng',
            rankValue: 1,
                ...
                <div class="modal-body promotion-modal-body">
                    ...
                    <div class="admin-form-grid promotion-form-grid">
                        ...
                        <div class="admin-form-group">
                            ...
                            <input type="text" id="formPromotionValueLabel" placeholder="VD: Giảm 20% hoặc Miễn phí giao hàng">
                        </div>
                        <div class="admin-form-group">
