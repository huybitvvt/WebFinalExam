...
function handleForgotPass(event) {
    ...
    if (user && user.password) {
        const temporaryPassword = `GS${Math.floor(1000 + Math.random() * 9000)}`;
        ...
        showAuthMessage('Đã tạo mật khẩu tạm thời mới cho tài khoản này.', 'success');
        recoveredPasswordEl.innerText = temporaryPassword;
